                ...
                <div class="p-3">
                    ...
                    <form class="form-horizontal mt-3" method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group mb-3 row">
                            <div class="col-12">
                                <input class="form-control" name="name" id="name" type="name" required="" placeholder="Name">
                            </div>
                        </div>

                        <div class="form-group mb-3 row">
                            <div class="col-12">
                                <input class="form-control" name="username" id="username" type="username" required="" placeholder="Username">
                            </div>
                        </div>
