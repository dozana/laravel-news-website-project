                        ...
                        <div class="card-body">
                            <form method="post" action="{{ route('update.subcategory', $subcategory->id) }}">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('subcategory_name') is-invalid @enderror" name="subcategory_name" id="subcategory_name" value="{{ $subcategory->subcategory_name }}">
